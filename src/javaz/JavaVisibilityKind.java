 ...
 * <!-- end-user-doc -->
 * @see javaz.JavazPackage#getJavaVisibilityKind()
 * @model
 * @generated
 */
public enum JavaVisibilityKind implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	public static final List<JavaVisibilityKind> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
