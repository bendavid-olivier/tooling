...
public class ObjectImpl extends PolicyElementImpl implements policy.Object
{
  ...
  public EList getPermissions()
  {
    if (permissions == null)
    {
      permissions = new EObjectWithInverseResolvingEList.ManyInverse(Permission.class, this, PolicyPackage.OBJECT__PERMISSIONS, PolicyPackage.PERMISSION__OBJECTS);
    }
    return permissions;
  }
  ...
  public EList getOperations()
  {
    if (operations == null)
    {
      operations = new EObjectWithInverseResolvingEList.ManyInverse(Operation.class, this, PolicyPackage.OBJECT__OPERATIONS, PolicyPackage.OPERATION__OBJECTS);
    }
    return operations;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case PolicyPackage.OBJECT__IS_INSTANCE:
        return isIsInstance() ? Boolean.TRUE : Boolean.FALSE;
    }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case PolicyPackage.OBJECT__NODE_NAME:
        ...
        return;
      case PolicyPackage.OBJECT__IS_INSTANCE:
        setIsInstance(((Boolean)newValue).booleanValue());
        return;
    }
