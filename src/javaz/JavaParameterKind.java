 ...
 * <!-- end-user-doc -->
 * @see javaz.JavazPackage#getJavaParameterKind()
 * @model
 * @generated
 */
public enum JavaParameterKind implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	public static final List<JavaParameterKind> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
