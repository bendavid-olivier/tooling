/*******************************************************************************
 * Pattern signature of the policy.policy pattern
...
/**
 * Pattern-specific signature object of the policy.policy pattern.
...
public final class PolicySignature extends BasePatternSignature implements IPatternSignature {

	// constructor
	public PolicySignature(Object POLICY) {
		this.fPOLICY = POLICY;	
	}

	//private attributes
	private Object fPOLICY;
	
	// getter methods
	/** Returns the value of the parameter with the given name, or null if name is invalid. */
	@Override
	public Object get(String parameterName) {
		if ("POLICY".equals(parameterName)) return fPOLICY;
		return null;
	}	
	
	public Object getValueOfPOLICY(){
		 return fPOLICY;
	}	
	...
	public void setValueOfPOLICY(Object POLICY){
		 this.fPOLICY=POLICY;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!patternName().equals(otherSig.patternName()))
			return false;
		if (!PolicySignature.class.equals(obj.getClass()))
			return Arrays.deepEquals(toArray(), otherSig.toArray());
		PolicySignature other = (PolicySignature) obj;
		if (fPOLICY == null) {if (other.fPOLICY != null) return false;}
		else if (!fPOLICY.equals(other.fPOLICY)) return false;
		return true;
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((fPOLICY == null) ? 0 : fPOLICY.hashCode());
		return result;
	}
	...
	private static String[] parameterNames = {"POLICY"};
