...
public class KevoreeTextualEditor extends JFrame{
  ...
  public KevoreeTreeMonitor tree;
  ...
  public KevoreeTextualEditor(Kevoree x ){
		kevoree = x;
 		setLayout(new BorderLayout());
		initGraphicalComponents();
		initControllers();
  ...
  public void initGraphicalComponents(){
		...
		tree = new KevoreeTreeMonitor(this);
  ...
  public Kevoree getKevoree(){
		return kevoree;

  }
  public void setKevoree(Kevoree x ){
		kevoree=x;
