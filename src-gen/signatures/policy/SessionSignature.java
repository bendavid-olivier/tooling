...
public final class SessionSignature extends BasePatternSignature implements IPatternSignature {
	...
	// constructor
	public SessionSignature(Object SESSION) {
		this.fSESSION = SESSION;	
	}

	//private attributes
	private Object fSESSION;
	
	// getter methods
	/** Returns the value of the parameter with the given name, or null if name is invalid. */
	@Override
	public Object get(String parameterName) {
		if ("SESSION".equals(parameterName)) return fSESSION;
		return null;
	}	
	
	public Object getValueOfSESSION(){
		 return fSESSION;
	}	
	...
	public void setValueOfSESSION(Object SESSION){
		 this.fSESSION=SESSION;
	}
	...
	public boolean equals(Object obj) {
		...
		if (fSESSION == null) {if (other.fSESSION != null) return false;}
		else if (!fSESSION.equals(other.fSESSION)) return false;
		return true;
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((fSESSION == null) ? 0 : fSESSION.hashCode());
		return result;
	}
	...
	public String prettyPrint() {
		...
		result.append("\"SESSION\"=" + prettyPrintValue(fSESSION));
	...
	private static String[] parameterNames = {"SESSION"};
