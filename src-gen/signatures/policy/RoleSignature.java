/*******************************************************************************
 * Pattern signature of the policy.role pattern
...
/**
 * Pattern-specific signature object of the policy.role pattern.
...
public final class RoleSignature extends BasePatternSignature implements IPatternSignature {

	// constructor
	public RoleSignature(Object ROLE) {
		this.fROLE = ROLE;	
	}
	...
	public boolean equals(Object obj) {
		...
		if (!patternName().equals(otherSig.patternName()))
			return false;
		if (!RoleSignature.class.equals(obj.getClass()))
			return Arrays.deepEquals(toArray(), otherSig.toArray());
		RoleSignature other = (RoleSignature) obj;
	...
	private static String[] parameterNames = {"ROLE"};
