...
public class PatternBuilderForpermission implements IStatelessGeneratedRetePatternBuilder {
	...
	public Address<? extends Receiver> construct(
		...
		final Address<? extends Receiver> var_10 = buildable.patternCollector("policy.permission");
		final Stub<Address<? extends Supplier>> var_11 = buildable.buildStartStub(new Object[] {}, new Object[] {});
		final Object var_12 = EPackage.Registry.INSTANCE.getEPackage("http://policy/1.0").getEClassifier("Permission");
		final Stub<Address<? extends Supplier>> var_13 = buildable.unaryTypeStub(new FlatTuple(new Object[] {"PERMISSION"}), var_12);
