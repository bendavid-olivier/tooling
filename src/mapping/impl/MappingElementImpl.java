 ...
 * <ul>
 *   <li>{@link mapping.impl.MappingElementImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MappingElementImpl extends EObjectImpl implements MappingElement
{
  ...
  public void setName(String newName)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.MAPPING_ELEMENT__NAME, oldName, name));
	}
  ...
  {
		switch (featureID) {
			case MappingPackage.MAPPING_ELEMENT__NAME:
				return getName();
		}
